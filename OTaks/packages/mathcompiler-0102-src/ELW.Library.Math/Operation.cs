...
namespace ELW.Library.Math {
    ...
    public sealed class Operation {
        ...
        /// Kind of operation.
        /// </summary>
        public OperationKind Kind => kind;
        ...
        /// Count of operands.
        /// </summary>
        public int OperandsCount => operandsCount;

        private readonly IOperationCalculator calculator;
        /// <summary>
        /// Calculator for this operation.
        /// </summary>
        public IOperationCalculator Calculator => calculator;
        ...
        public override string ToString ( ) => string.Format("{0} {1}", kind, name);
    }
}