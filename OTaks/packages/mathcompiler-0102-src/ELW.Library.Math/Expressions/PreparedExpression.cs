...
namespace ELW.Library.Math.Expressions {
    ...
    public sealed class PreparedExpression {
        ...
        public List<PreparedExpressionItem> PreparedExpressionItems => preparedExpressionItems;
    ...
    public sealed class PreparedExpressionItem {
        ...
        public PreparedExpressionItemKind Kind => kind;
        ...
        public DelimiterKind DelimiterKind => delimiterKind;
        ...
        public override string ToString ( ) => 
            string.Format("PreparedExpressionItem {0}", kind);
    }
}